...
class ImageContainer {
    ...
    public static void initImageContainer() {
        ...
        addImage(ImageID.MENU_BACKGROUND_ROOSTER, new Image("images/menu/menu-background-roostermenu.png"));
        addImage(ImageID.MENU_BACKGROUND_LOADING, new Image("images/menu/menu-background-loading.png"));
        addImage(ImageID.MENU_BACKGROUND_START, new Image("images/menu/menu-background-startmenu.png"));
        ...
        //Rooster (1):
        addImage(ImageID.MENU_ROOSTER_HELP, new Image("images/menu/menu-rooster-help.png"));

        //Start (1):
        addImage(ImageID.MENU_STARTMENU_HELP, new Image("images/menu/menu-startmenu-help.png"));
